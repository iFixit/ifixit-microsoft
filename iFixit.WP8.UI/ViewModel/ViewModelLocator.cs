/*
  ...
  <Application.Resources>
      <vm:ViewModelLocator xmlns:vm="clr-namespace:iFixit.WP8.UI"
                           x:Key="Locator" />
  </Application.Resources>
...
namespace iFixit.UI.ViewModel
{
    ...
    public class ViewModelLocator
    {
        ...
        public ViewModelLocator()
        {
            ...
            SimpleIoc.Default.Register<Domain.Interfaces.INavigation<iFixit.Domain.Interfaces.NavigationModes>, iFixit.UI.Services.UiNavigation>();
            SimpleIoc.Default.Register<Domain.Interfaces.IStorage, iFixit.UI.Services.UiStorage>();
            SimpleIoc.Default.Register<Domain.Interfaces.ISettings, iFixit.UI.Services.UiSettings>();
            SimpleIoc.Default.Register<Domain.Interfaces.IUxService, iFixit.UI.Services.UiUx>();
